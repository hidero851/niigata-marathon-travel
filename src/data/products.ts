...
export const allProducts: LocalProduct[] = [
  ...
  {
    id: 'machida-shoyu',
    name: '町田醤油味噌醸造場（越後高田の醤油）',
    area: '上越市',
    imageUrl: '',
    imageGradient: 'linear-gradient(135deg, #5c2a0a, #9c4a1a)',
    shortDescription: '明治8年創業、上越・高田が育んだ地醤油',
    description:
      '明治8年創業、新潟県上越市に蔵を構える老舗醤油醸造場。仕込みから一貫生産にこだわり、添加物不使用の本醸造醤油は大豆本来の旨みとすっきりした風味が特徴。越後高田旨口醤油はかけ・煮物・卵かけご飯まで幅広く使える地元の定番。丸大豆を使った「あぜみち」や甘口の「月印しょうゆ」など、上越の食文化を支える多彩なラインナップを持つ。醤油のほか越後味噌・甘酒・しょうゆの実（あじもろみ）・かぐらなんばん辛味噌など発酵食品全般を製造。',
    recommendedPoint:
      '上越・高田の食卓に根付いた地醤油。旅のお土産にも喜ばれる地元ならではの風味を、ぜひ現地で手に取ってみてください。',
