...
export const allProducts: LocalProduct[] = [
  ...
  },
  {
    ...
    description:
      '翁飴は江戸時代から越後高田に伝わる銘菓。3代目孫左衛門が大阪より寒天を持ち帰り、水飴を寒天で固めて乾燥させるという独自の製法を確立した。当初は「翁羹」として販売されていたが、高田藩主・榊原公よりその名を賜り「翁飴」となった——この歴史的なエピソードが、今も店名とともに語り継がれている。もちっとした独特の食感と、あっさりとした上品な甘み。口の中でじんわりとほどける寒天飴は、甘いものが得意でない人にも「これなら食べられる」と言わせる品のよさがある。常温60日間保存できるから、遠方へのお土産にも安心。新宿髙島屋の銘菓百選にも選ばれた、越後高田が誇る一品。',
    recommendedPoint:
  ...
  },
  {
    ...
    description: '天然の魚沼産よもぎを使用したよもぎのきんつばです。摘み取ったよもぎを家伝のきんつば餡と生地に加え薄く焼き上げました。よもぎの風味とほのかな香りがたまらない美味しいきんつばです。魚沼土産におすすめの逸品です。魚沼市プレミアム認定品。',
    recommendedPoint: 'よもぎの香りと上品な甘さがゴール後の疲れを癒してくれる一品。レース後の自分へのご褒美に、また応援してくれた家族へのお土産にもぴったりです。',
    whereToBuy: 'にいがた本高砂屋本店・原信小出東店・道の駅など',
    salesLocations: ['にいがた本高砂屋本店', '原信小出東店', '道の駅ゆのたに', 'まちの駅魚沼'],
  ...
  },
  {
    ...
    description: '魚沼産コシヒカリの米粉を使用して焼き上げた米粉のバウムクーヘンです。自社工房で専属パティシエが素材にこだわり一層一層丁寧に焼き上げています。魚沼市プレミアム認定品。',
  ...
  },
  {
    ...
    description: '野沢菜漬を細かく刻んで野菜と合わせた魚沼地域の郷土食。八海山水系の伏流水と煮干醤油が味の決め手。納豆と和えて食べるのが「きりざい丼」としておすすめです。魚沼市プレミアム認定品。',
  ...
  },
  {
    ...
    description: '魚沼に伝わる郷土食「夏納豆」の現代版。国産大豆のふっくら中粒の納豆を、国産米米糀・笹川流れの塩・三河のみりんなどで味付調理しました。新潟県魚沼のお土産品として長年ご愛顧いただいております。使い方色々お楽しみいただけます。魚沼市プレミアム認定品。',
